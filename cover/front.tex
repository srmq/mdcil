...
\resizebox{.8\linewidth}{!}{\scshape Matemática Discreta}

\vskip .75em

\resizebox{.6\linewidth}{!}{\scshape para Computação}

\vskip .6in

\resizebox{.7\linewidth}{!}{\scshape Uma Introdução Livre}

\vskip 1in

\resizebox{.4\linewidth}{!}{\scshape Sergio Queiroz}

\vskip 1.25in

\resizebox{.25\linewidth}{!}{\scshape Novembro de 2020}
